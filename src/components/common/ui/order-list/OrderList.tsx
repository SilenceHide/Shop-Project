...
export default function OrderList({
  ...
  return (
    <div className="bg-white flex flex-col gap-[30px] items-center justify-between shadow-c rounded-[10px] border-[1px] border-border-gray py-7 px-8 sm:max-h-[560px] xl:min-w-[605px] sm:min-w-[520px] max-w-[605px] shadow-main-shadow overflow-y-auto">
