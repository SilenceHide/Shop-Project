        ...
        <div className="flex flex-col lg:grid lg:grid-cols-[2fr_1.5fr] xl:grid-cols-[2fr_1fr] gap-6 mt-12">
          <div className="flex flex-col md:grid md:grid-cols-2 gap-6">
            <div className="lg:col-span-2 2xl:col-span-1 text-medium text-gray-500 bg-white flex gap-[7px] py-[13px] items-center justify-center shadow-c rounded-[10px] border-[1px] border-gray-200">
              ...
              <img
                src="../assets/icons/fi-rs-user.svg"
                width="16"
                height="16"
                alt="unanimous user"
              />
              <div>Already have an account?</div>
              <a className="text-green-200" href="#">
                Click here to login
              </a>
            </div>
            <div className="lg:col-span-2 2xl:col-span-1 focus-within:border-green-200 bg-white text-medium text-gray-500 flex gap-[7px] items-center justify-between shadow-c rounded-[10px] border-[1px] border-gray-200 min-h-[52px]">
              ...
              <button className="font-quickSand text-heading6 bg-blue-300 h-full min-h-[52px] rounded-r-[10px] text-white px-7">
                Apply Coupon
              </button>
            </div>
            ...
            <div className="col-span-2 focus-within:border-green-200 bg-white flex gap-[7px] items-center justify-between shadow-c rounded-[10px] border-[1px] border-gray-200 py-4 px-8 min-h-[210px]">
              ...
              <textarea
                ...
                className="resize-none w-full h-full bg-transparent placeholder-gray-400 focus:outline-none text-gray-500 text-medium"
              ></textarea>
            </div>
          ...
          <div className="flex flex-col gap-[70px]">
            <div className="bg-white flex flex-col gap-[30px] items-center justify-between shadow-c rounded-[10px] border-[1px] border-gray-200 py-4 px-8 max-h-[560px] overflow-y-auto">
              ...
              <div className="grid grid-cols-[minmax(0,_2fr)_minmax(0,_4fr)_minmax(0,_1fr)_minmax(0,_1fr)] gap-7 w-full">
                ...
                <div className="font-quickSand text-heading6 flex justify-center items-center py-[22px]">
                  Field Roast Chao Cheese Creamy Original
                </div>
                <div className="font-lato text-heading4 text-gray-400 flex justify-center items-center">
                  × 1
                </div>
                <div className="font-lato text-heading4 text-green-200 flex justify-center items-center">
                  $2.51
                </div>
              </div>
              <div className="grid grid-cols-[minmax(0,_2fr)_minmax(0,_4fr)_minmax(0,_1fr)_minmax(0,_1fr)] gap-7 w-full">
              ...
              <div className="flex flex-col items-start gap-4 mt-7">
                <div className="flex items-center justify-start gap-2">
                  <input
                    ...
                    checked
                  />
                  <label className="font-lato text-medium text-gray-500" htmlFor="direct-transfer">
                ...
                <div className="flex items-center justify-start gap-2">
                  <input
                    ...
                    className="accent-green-200 w-4 h-4"
                  />
                  <label className="font-lato text-medium text-gray-500" htmlFor="on-delivery">
                    Cash on delivery
                  </label>
                </div>
                <img
                  src="../assets/images/payment-method%202.png"
                  alt="payment method"
                  width="307"
                  height="21"
                />
